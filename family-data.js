...
{id:'sheila',name:'Sheila',sex:'F',branch:'Radis',generation:'Tios',evidenceStatus:'confirmed',tags:[],conditions:[],sources:[],notes:'Irmã de Ritheli.'},
...
{id:'zeli',name:'Zeli Radis',sex:'F',branch:'Radis',generation:'Avós',evidenceStatus:'family-report',tags:[],conditions:[],sources:[],notes:'Mãe de Elielton e Elenilton.'},
...
{id:'manoel',name:'Manoel Radis',sex:'M',branch:'Radis',generation:'Ancestrais',evidenceStatus:'investigate',tags:['conexão a confirmar'],conditions:[],sources:[],notes:'Conexão exata com este ramo ainda precisa ser confirmada por documentos/vídeo familiar.'},
